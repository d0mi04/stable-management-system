...
const Schedule = () => {
  ...
  const handleAddEvent = async () => {
    ...
    if (email && horseName) {
      const emailUrl = `https://send-email-381376669818.europe-west1.run.app?email=${encodeURIComponent(
        email
      )}&horseName=${encodeURIComponent(horseName)}&date=${encodeURIComponent(
        formattedDate
